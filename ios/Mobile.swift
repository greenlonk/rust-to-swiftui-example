...
public func computeExample(x: Int32)  -> String {
    return try!  FfiConverterString.lift(
        try! rustCall() {
    uniffi_mobile_fn_func_compute_example(
        FfiConverterInt32.lower(x),$0)
}
    )
}

public func countPrimes(limit: Int32)  -> Int32 {
    return try!  FfiConverterInt32.lift(
        try! rustCall() {
    uniffi_mobile_fn_func_count_primes(
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_mobile_checksum_func_compute_example() != 4552) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mobile_checksum_func_count_primes() != 32315) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mobile_checksum_func_greet() != 49937) {
        return InitializationResult.apiChecksumMismatch
    }
